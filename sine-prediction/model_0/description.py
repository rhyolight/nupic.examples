...
config ={
  ...
  'modelParams' : {'sensorParams': {'encoders': {u'sine': {'maxval': 1.0, 'name': 'sine', 'clipInput': True, 'minval': -1.0, 'n': 396, 'fieldname': 'sine', 'w': 21, 'type': 'ScalarEncoder'}}}, 'spParams': {'synPermInactiveDec': 0.025225000000000004}, 'tpParams': {'minThreshold': 11, 'activationThreshold': 15, 'pamLength': 4}, 'clParams': {'alpha': 0.075025000000000008}},
